...
////
////  Revised to support multi-language playback and per-language speed selection.
////  Debug print statements have been removed except those that log every time a speed is set.
////  These debug prints show which function is setting the speed and the value passed to audioManager.setRate(…).
////
//
//import SwiftUI
//import SwiftData
...
//    @State private var currentPlaybackStage: Int = 1
//
//    /// Flag indicating if a chapter/subbook change is internal.
//    @State private var internalNavigation: Bool = false
//
//    // MARK: - Playback Options State
//    @State private var selectedLanguage1: String = "English"
...
//    }
//    
//    // Helper: Debug global state (optional).
...
//                                audioManager.pause()
//                                audioManager.onPlaybackFinished = nil
//                                print("[Play/Pause] Pausing playback. Current stage: \(currentPlaybackStage)")
//                            } else if !isAtEnd {
//                                // Do not reset playback stage here.
//                                isPlaying = true
//                                print("[Play/Pause] Resuming playback. Current stage: \(currentPlaybackStage)")
//                                // Use a helper that loads the sentence according to the current playback stage.
//                                if let sentence = sentenceForCurrentStage() {
//                                    audioManager.loadAudio(for: sentence)
//                                    if currentPlaybackStage == 1 {
//                                        audioManager.setRate(Float(selectedSpeed1))
...
//            updateGlobalAppStateForBookDetail()
//            audioManager.setRate(Float(selectedSpeed2))
//            print("[Speed] Secondary speed updated to \(selectedSpeed2)")
//        }
//        .onChange(of: selectedSpeed3) {
//            saveBookState()
//            updateGlobalAppStateForBookDetail()
//            audioManager.setRate(Float(selectedSpeed3))
//            print("[Speed] Tertiary speed updated to \(selectedSpeed3)")
//        }
//    }
//    
//    // MARK: - Helper: Get Sentence for Current Stage
...
//        if currentPlaybackStage == 1 {
//            return currentSentenceContent()
//        } else if currentPlaybackStage == 2, let langCode = selectedLanguage2Code {
//            let content = loadChapterContent(language: langCode)
//            return content.flatMap { getCurrentSentence(from: $0, at: currentSentenceIndex) }
//        } else if currentPlaybackStage == 3, let langCode = selectedLanguage3Code {
//            let content = loadChapterContent(language: langCode)
//            return content.flatMap { getCurrentSentence(from: $0, at: currentSentenceIndex) }
//        }
//        return nil
