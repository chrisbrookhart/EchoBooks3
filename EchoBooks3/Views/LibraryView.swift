...
////
////  Created by [Your Name] on [Date].
////  Revised for responsive layout with a search bar in the navigation bar,
////  updated section headings, multi-line book titles, and a subscription icon.
////
//
//import SwiftUI
//
//struct LibraryView: View {
//    // MARK: - State Variables
//    @State private var books: [Book] = []            // Downloaded books from BookImporter.
//    @State private var searchText: String = ""         // Search text.
//    
//    // MARK: - Computed Properties
//    /// Filters the downloaded books by title.
...
//                let screenWidth = geometry.size.width
//                let itemWidth = max(80, screenWidth * 0.25)
//                let itemHeight = itemWidth * 1.5  // Using a 2:3 ratio for book covers.
//                
//                ScrollView {
//                    VStack(alignment: .leading, spacing: 24) {
//                        
...
//                            
//                            if filteredBooks.isEmpty {
//                                // Empty state view if no downloaded books match.
//                                VStack(spacing: 8) {
//                                    Text("No downloaded books found.")
//                                    Text("Please download some books.")
//                                        .foregroundColor(.secondary)
...
//                        }
//                        
//                        // MARK: Available for Download Section (Placeholder)
//                        VStack(alignment: .leading, spacing: 8) {
//                            Text("Available for Download")
//                                .font(.headline)
//                                .padding(.horizontal)
...
//                }
//            }
//            // Remove the default title by setting an empty string.
//            .navigationTitle("")
//            .toolbar {
//                // Subscription icon in the top-right of the navigation bar.
//                ToolbarItem(placement: .navigationBarTrailing) {
//                    NavigationLink(destination: ManageSubscriptionView()) {
//                        Image(systemName: "person.crop.circle")
//                    }
...
//            }
//        }
//        // Move the search bar to the navigation bar using .searchable.
//        .searchable(text: $searchText, prompt: "Search Books")
//        .onAppear {
//            self.books = BookImporter.importBooks()
//        }
...
//    
//    // MARK: - Helper: Cover Image Lookup
//    /// Returns an Image for the book's cover, stripping any file extension from the asset name.
//    private func coverImage(for book: Book) -> Image {
//        let assetName = (book.coverImageName as NSString).deletingPathExtension
//        if UIImage(named: assetName) != nil {
//            return Image(assetName)
